<?php
return [
    'supportEmail'                  => 'feifeiaini1@gmail.com',
    'user.passwordResetTokenExpire' => 3600,
    'site'                          => [
        /*
         * because frontend and backend may have different domain. but CMS put all uploads files to frontend/web/uploads.
         ...
         *
         * 因为前台和后台可能使用不同的域名，但是CMS把所有上传的文件放在frontend/web/uploads。
         * 因为，在后台显示已上传的图片时，需要拼接这个前台的域名才能正常显示图片。
         * 此值，会被后台管理页面填入的值覆盖掉（如果填入的值不为空的话）
         */
        'url'  => 'https://www.cwmjy.com',

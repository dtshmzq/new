...
return [
    ...
    */
    ...
    'components' => array_merge([
        /**
         * dsn:
         *  - mysql mysql:host=localhost;dbname=sfjvip
         *  - sqlite sqlite:/sfjvip.db
         */
        'db' => [//database config, will be covered by backend|frontend|api]/main-[local].php
            'class' => yii\db\Connection::className(),
            'dsn' => 'sqlite:/sfjvip.db',
            'username' => '',
            'password' => '',
            'charset' => '',
        ],
...
//                'host' => 'smtp.sfjvip.com',
//                'username' => 'admin@sfjvip.com',
//                'password' => 'password',
//                'port' => '586',
//                'encryption' => 'tls',
//            ],
//            'messageConfig' => [
//                'charset' => 'UTF-8',
//                'from' => ['feifeiaini1@gmail.com' => 'CMS robot ']
//            ],
//        ],
        'feiber' => [
            'class' => common\components\FeiberInit::className(),
        ],
        'authManager' => [

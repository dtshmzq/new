...
class User extends \yii\db\ActiveRecord implements IdentityInterface
{
    ...
    {
        if($this->avatar !== "0") {//为0表示需要删除图片，Util::getInstance()->handleModelSingleFileUpload()会有判断删除图片
    ...
    public function beforeSave($insert)
    {
        ...
        Util::getInstance()->handleModelSingleFileUpload($this, 'avatar', $insert, '@frontend/web/uploads/avatar/');
    ...
    public function beforeDelete()
    {
        ...
        try {
            Util::getInstance()->deleteThumbnails(Yii::getAlias('@frontend/web') . $this->avatar, [], true);

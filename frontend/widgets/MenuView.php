...
class MenuView extends \yii\base\Widget
{
    ...
    public $template = "<ul class='sub'>{lis}</ul>";

    public $liTemplate = "<li><a href='{url}' >{title}</a></li>";

    public $subTemplate = "<ul class='sub'>{lis}</ul>";

    public $subLitemplate = "<li><a href='{url}'>'{title}'</a></li>";

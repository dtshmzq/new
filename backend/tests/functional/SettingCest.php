...
class SettingCest
{
    ...
    public function checkWebsite(FunctionalTester $I)
    {
        ...
        $I->submitForm("button[type=submit]", [
            'SettingWebsiteForm[website_title]' => "testCMS",
        ]);
        $I->seeInField("SettingWebsiteForm[website_title]", "testCMS");
    }
    ...
    public function checkSMTP(FunctionalTester $I)
    {
        ...
        $I->submitForm("button[type=submit]", [
            'SettingSMTPForm[smtp_username]' => "test@feiber.com",
            'SettingSMTPForm[smtp_host]' => 'smtp.126.com',
        ]);
        $I->seeInField("SettingSMTPForm[smtp_username]", "test@feiber.com");
    }

...
use backend\actions\StateAction;
        ...
        return [
            ...
            'create'     => [
                ...
                'data'     => function($createResultModel, CreateAction $createAction) use ($service, $categoryService) {
                    return [
                        'model'        => $createResultModel === null ? $service->newModel(['scenario' => ArticleServiceInterface::ScenarioArticle])
                            : $createResultModel['articleModel'],
            ...
            'update'     => [
                ...
                'data'     => function($id, $updateResultModel) use ($service, $categoryService) {
                    return [
                        'model'        => $updateResultModel === null ? $service->getDetail($id, ['scenario' => ArticleServiceInterface::ScenarioArticle])
                            : $updateResultModel['articleModel'],
            ...
            'state'     => [
                'class'    => StateAction::className(),
                'doState' => function($id, $postData) use ($service) {
                    return $service->state($id, $postData, ['scenario' => ArticleServiceInterface::ScenarioArticle]);
                },
            ],
            'delete'     => [

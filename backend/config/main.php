...
return [
    ...
    'components'          => [
        ...
        'session'      => [
            'name'    => 'BACKEND_CMS',
            'timeout' => 3 * 86400,//session过期时间，单位为秒
        ],
        'log'          => [
            'traceLevel' => 0,
            'targets'    => [
...
//                    ],
//                    'message' => [
//                        'to'      => ['feifeiaini1@gmail.com'],//此处修改成自己接收错误的邮箱
...
//                ],
    ...
    'on beforeRequest'    => [common\components\FeiberInit::className(), 'backend'],
    'as access'           => [

...
class Bar extends Widget
{
    ...
    public $template = "{refresh} {create} {delete} {edit} {open}";
    ...
    protected function initDefaultButtons()
    {
        ...
        if (!isset($this->buttons['edit'])) {
            $this->buttons['edit'] = function () {
                return Html::a('<i class="fa fa-edit"></i> 批量编辑', 'javascript:;', [
                    'title'        => '批量编辑',
                    'data-pjax'    => '0',
                    'class'        => 'btn btn-white btn-sm edit',
                ]);
            };
        }

        if (!isset($this->buttons['open'])) {
            $this->buttons['open'] = function () {
                return Html::a('<i class="fa fa-folder-open-o"></i> 批量打开', 'javascript:;', [
                    'title'        => '批量打开',
                    'data-pjax'    => '0',
                    'class'        => 'btn btn-white btn-sm open',
                ]);
            };
        }
    }
